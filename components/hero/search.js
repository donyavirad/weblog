...
const Search = () => {
    return (
        <div className="flex items-center">
            <input
                type={"text"}
                className="h-10 px-4 shadow-box rounded-none rounded-tl-lg rounded-bl-lg font-Montserrat-Regular text-gray-800 focus-visible:outline-none placeholder:text-[#00000020]"
